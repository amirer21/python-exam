...
환경 설정이 잘못되거나 버전이 달라서 충돌 나는 경우가 있다. 이 경우에 설치하려는 파이썬 라이브러리의 위치를 확인하고 설치하는 것이 좋다.
파이썬 라이브러리의 위치를 확인하는 방법을 알아보자.
"""
...
# 파이썬 특정 라이브러리의 경로 확인
#get path of pip library in cmd.
...
#위에서 Location 항목만 가져오기
#pip print Location line of pip library path in windows cmd.
...
# Setting of Environment Variable in MacOS
# 1. Open Terminal
# 2. Open .bash_profile 
# $ open ~/.bash_profile
